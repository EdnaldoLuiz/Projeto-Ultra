<?php foreach ($computers as $computer): ?>
  <div class="card">
    <div class="card-img">
      <img src="data:image/png;base64,<?php echo base64_encode($computer['imagem']); ?>" alt="">
    </div>
    <div class="card-info">
      <h3 class="mt-2 card-title">
        <?php echo $computer['nome']; ?>
      </h3>
